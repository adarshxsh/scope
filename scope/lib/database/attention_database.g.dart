...
class $UserSettingsTableTable extends UserSettingsTable
  ...
  static const VerificationMeta _maxStorageMbMeta = const VerificationMeta(
    'maxStorageMb',
  );
  @override
  late final GeneratedColumn<int> maxStorageMb = GeneratedColumn<int>(
    'max_storage_mb',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('max_storage_mb')) {
      context.handle(
        _maxStorageMbMeta,
        maxStorageMb.isAcceptableOrUnknown(
          data['max_storage_mb']!,
          _maxStorageMbMeta,
        ),
      );
  ...
  UserSettingsEntry map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return UserSettingsEntry(
      ...
      maxStorageMb: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}max_storage_mb'],
      )!,
    );
  }
...
class UserSettingsEntry extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['max_storage_mb'] = Variable<int>(maxStorageMb);
    return map;
  }
  ...
  factory UserSettingsEntry.fromJson(
    ...
    return UserSettingsEntry(
      ...
      maxStorageMb: serializer.fromJson<int>(json['maxStorageMb']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'maxStorageMb': serializer.toJson<int>(maxStorageMb),
    };
  }
  ...
  UserSettingsEntry copyWithCompanion(UserSettingsTableCompanion data) {
    return UserSettingsEntry(
      ...
      maxStorageMb: data.maxStorageMb.present
          ? data.maxStorageMb.value
          : this.maxStorageMb,
    );
  }
  ...
  String toString() {
    return (StringBuffer('UserSettingsEntry(')
          ...
          ..write('maxStorageMb: $maxStorageMb')
          ..write(')'))
        .toString();
  }
  ...
  @override
  int get hashCode =>
      Object.hash(id, retentionDays, telemetryEnabled, maxRowCap, maxStorageMb);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is UserSettingsEntry &&
          ...
          other.maxStorageMb == this.maxStorageMb);
}
...
class UserSettingsTableCompanion extends UpdateCompanion<UserSettingsEntry> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (maxStorageMb.present) {
      map['max_storage_mb'] = Variable<int>(maxStorageMb.value);
    }
    return map;
  }
...
class $$UserSettingsTableTableFilterComposer
  ...
  ColumnFilters<int> get maxStorageMb => $composableBuilder(
    column: $table.maxStorageMb,
    builder: (column) => ColumnFilters(column),
  );
}
...
class $$UserSettingsTableTableOrderingComposer
  ...
  ColumnOrderings<int> get maxStorageMb => $composableBuilder(
    column: $table.maxStorageMb,
    builder: (column) => ColumnOrderings(column),
  );
}
...
class $$UserSettingsTableTableAnnotationComposer
  ...
  GeneratedColumn<int> get maxStorageMb => $composableBuilder(
    column: $table.maxStorageMb,
    builder: (column) => column,
  );
}
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int> maxStorageMb = const Value.absent(),
