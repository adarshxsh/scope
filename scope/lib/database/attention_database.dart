...
class AttentionDatabase extends _$AttentionDatabase {
  ...
  /// enforce row caps and storage quotas, and remove orphaned review queue entries.
  Future<void> runSetBasedCleanup([
    ...
    final effectiveRowCap = maxRowCap ?? settings.maxRowCap;
    ...
    await transaction(() async {
      // 1. Delete expired notifications based on cutoff timestamp (if retention is enabled)
