...
class AttentionDatabase extends _$AttentionDatabase {
  ...
  /// Deletes orphaned review queue entries whose notifications no longer exist.
  Future<int> cleanupOrphanedReviewQueue() async {
  ...
  Future<void> runSetBasedCleanup(int cutoffTimestamp) async {
    await transaction(() async {
      ...
      await cleanupOrphanedReviewQueue();
    });
  }
}
