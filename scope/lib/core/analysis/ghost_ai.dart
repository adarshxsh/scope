...
class GhostAI {
  ...
  void _logStructured(AppNotification notification, GhostAIResult result) {
    ...
    debugPrint('Notification ID: ${notification.id} | Package: ${notification.packageName} | Title Len: ${notification.title.length} | Content Len: ${notification.content.length}');
