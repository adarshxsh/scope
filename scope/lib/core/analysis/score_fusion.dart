...
class ScoreFusion {
  ...
  static AnalysisResult fuse({
    ...
    final isModelFallback =
        modelResult.isFallback || modelResult.engineName.toLowerCase().contains('fallback');
    ...
    if (isModelFallback) {
      if (ruleResult != null) {
        return AnalysisResult(
          category: ruleResult.category,
          score: 0.85, // Retain custom rule baseline without unauthentic model score blending
