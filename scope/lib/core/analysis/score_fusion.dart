  ...
  static AnalysisResult fuse({
    ...
    if (modelResult.isFallback) {
      if (ruleResult != null) {
        ...
        return AnalysisResult(
          category: ruleResult.category,
          score: ruleScore, // Custom rule baseline without unauthentic model score blending
    ...
    // 3. Normal score fusion - if no rule matches, rely on calibrated model prediction
    if (ruleResult == null) {
    ...
    // 4. Dynamic Category Precision Fusion: Both rule and model match
