...
class AppSettingsNotifier extends StateNotifier<AppSettingsState> {
  ...
  Future<void> setRetentionDays(int days) async {
    ...
    final db = _db;
    if (db != null) {
      await db.appSettingsDao.updateSettings(retentionDays: days);
    }
  }
  ...
  Future<void> setStorageQuota(int count) async {
    ...
    final db = _db;
    if (db != null) {
      await db.appSettingsDao.updateSettings(storageQuota: count);
    }
  }
  ...
  Future<void> setTelemetryEnabled(bool enabled) async {
    ...
    final db = _db;
    if (db != null) {
      await db.appSettingsDao.updateSettings(telemetryEnabled: enabled);
    }
  }
}
