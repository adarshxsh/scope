...
void main() {
  ...
  for (final relativePath in targetAssets) {
    ...
    stdout.writeln('Manifest entry generated for $relativePath: sha256=$digest, length=${bytes.length}');
  }
  ...
  stdout.writeln('Successfully generated ${manifestFile.path} with ${manifestEntries.length} entries.');
}
