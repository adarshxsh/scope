...
class NotificationCollectorService : NotificationListenerService() {
    ...
    private fun addSbnToQueue(sbn: StatusBarNotification) {
        try {
            ...
            queue.add(data)
            Log.d(TAG, "Captured notification from ${data.packageName} (id=${data.id}, lowPower=$lowPower) - ${NotificationRedactor.redactTitle(data.title)}")
        } catch (e: Exception) {
    ...
    override fun onNotificationRemoved(sbn: StatusBarNotification?) {
        ...
        Log.d(TAG, "Removed notification from ${sbn.packageName} - ${NotificationRedactor.redactTitle(removedTitle)}")
    }
