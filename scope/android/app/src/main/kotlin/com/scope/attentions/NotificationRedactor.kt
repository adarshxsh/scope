...
object NotificationRedactor {
    ...
    private val tokenRegex = Regex("""(?i)\b(?:token|auth|session|key)\s*[:=]\s*[A-Za-z0-9._\-]+|(?i)\b(?:bearer)\s*[:=]?\s*[A-Za-z0-9._\-]+\b(?![=:])|\b[A-Fa-f0-9]{32,64}\b|\beyJ[A-Za-z0-9_-]+\.[A-Za-z0-9_-]+\.[A-Za-z0-9_-]+\b""")
